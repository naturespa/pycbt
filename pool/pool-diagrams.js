...
(() => {
  ...
  const structure = i => {
    ...
    if(i===2) return svg('スタックの上端から新しいデータを追加する。',box(270,12,100,38,'新規')+arrow(320,52,320,96)+text(435,73,'上端へ追加')+box(270,100,100,40,'B')+box(270,140,100,40,'A')+text(420,121,'上端'),210);
    const top='C';
